...
Prêt ? C'est parti ! 🚀""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': 'Python a été créé par Guido van Rossum.', 'is_true': True},
                            {'statement': 'Python est un langage payant.', 'is_true': False},
                            {'statement': 'Python est utilisé en intelligence artificielle.', 'is_true': True},
                            {'statement': 'Python ne peut fonctionner que sur Windows.', 'is_true': False},
                        ],
                    },
                ],
            },
...
Calcule leur **moyenne** (somme divisée par 3) et affiche le résultat avec `print()`.""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "L'expression 6 / 2 donne 3.0", 'is_true': True},
                            {'statement': "L'expression 7 // 2 donne 3.5", 'is_true': False},
                            {'statement': "L'expression 2 ** 3 donne 8", 'is_true': True},
                            {'statement': "L'expression 5 == 5 donne False", 'is_true': False},
                        ],
                    },
                ],
            },
...
`7 x 10 = 70`""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': 'range(5) génère 0, 1, 2, 3, 4', 'is_true': True},
                            {'statement': "break permet de passer à l'itération suivante", 'is_true': False},
                            {'statement': "continue permet de sortir d'une boucle", 'is_true': False},
                            {'statement': "Une boucle while peut ne jamais s'exécuter si la condition est fausse au départ", 'is_true': True},
                        ],
                    },
                ],
            },
...
Teste avec `print(maximum([3, 7, 2, 9, 5]))` qui doit afficher `9`.""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "Les listes sont mutables en Python", 'is_true': True},
                            {'statement': "append() ajoute un élément au début de la liste", 'is_true': False},
                            {'statement': "len([1, 2, 3]) renvoie 3", 'is_true': True},
                            {'statement': "liste[-1] accède au premier élément", 'is_true': False},
                        ],
                    },
                ],
            },
...
Teste avec `print(somme(100))` qui doit afficher `5050`.""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "Une fonction récursive doit toujours avoir un cas de base", 'is_true': True},
                            {'statement': "La récursivité est toujours plus rapide que l'itération", 'is_true': False},
                            {'statement': "Tout problème récursif peut être résolu itérativement", 'is_true': True},
                            {'statement': "factorielle(0) = 0", 'is_true': False},
                        ],
                    },
                ],
            },
...
```""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "O(1) signifie que le temps est constant quelle que soit la taille", 'is_true': True},
                            {'statement': "O(n) est plus lent que O(n²)", 'is_true': False},
                            {'statement': "Rechercher dans un set Python est O(1)", 'is_true': True},
                            {'statement': "Trier une liste avec sorted() est O(n)", 'is_true': False},
                        ],
                    },
                ],
            },
...
Crée `rex = Chien("Rex")` et appelle `rex.cri()`.""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "Une classe fille hérite automatiquement des méthodes de sa classe mère", 'is_true': True},
                            {'statement': "Une classe fille ne peut pas redéfinir une méthode de la classe mère", 'is_true': False},
                            {'statement': "isinstance(rex, Animal) renvoie True si rex est un Chien et Chien hérite d'Animal", 'is_true': True},
                            {'statement': "Une classe ne peut hériter que d'une seule autre classe", 'is_true': False},
                        ],
                    },
                ],
            },
...
Crée `c = CompteBancaire(1000)`, dépose 500, affiche le solde final (doit être 1500).""",
                    ...
                    },
                    {
                        ...
                        'statements': [
                            {'statement': "Le polymorphisme permet d'appeler la même méthode sur des objets de classes différentes", 'is_true': True},
                            {'statement': "Un attribut __solde est accessible directement avec objet.__solde", 'is_true': False},
                            {'statement': "@property permet de définir un getter élégant", 'is_true': True},
                            {'statement': "L'encapsulation sert à cacher l'implémentation et protéger les données", 'is_true': True},
                        ],
                    },
                ],
            },
